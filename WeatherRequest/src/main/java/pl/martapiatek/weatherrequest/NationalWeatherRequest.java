package pl.martapiatek.weatherrequest;

/**
 * Created by Marta on 12.09.2017.
 */
...
public class NationalWeatherRequest {
    ...
    private String readWeatherXml(InputStream inputStream) {
        ...
        if (inputStream!=null) {
            ...
            try {
                ...
                log("Wyjątek przy pobieraniu danych pogodowych z usługi " + e);
                e.printStackTrace();
            }
        }
    ...
    private InputStream getInputStream(URL url) {
        ...
        try {
            ...
            log("Wyjątek przy otwarciu adresu URL " + e);
            e.printStackTrace();
        }
        return inputStream;
    }
